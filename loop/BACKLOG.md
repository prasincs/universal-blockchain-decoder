...
- [x] *(auto-generated 2026-09)* **Bump alloy oracle 2.2.0 -> 2.4.1** (and
  `alloy-primitives` 1.6.1 -> 1.7.2) in decoder-ethereum dev-deps; re-run
  `alloy_differential`. (Done 2026-09; `cargo update` moved
...
- [ ] *(auto-generated 2026-09)* **Bump solana-transaction-status 4.1.2 ->
  ...
  Verify: `cargo test -p decoder-solana` differential test passes and
  `upstream_outdated` drops `solana-transaction-status`.
