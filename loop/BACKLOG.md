...
- [~] *(auto-generated 2026-08)* **Bump alloy oracle 2.2.0 -> 2.4.1** in
  decoder-ethereum dev-deps; re-run `alloy_differential`. Disagreements after
  the bump are findings (minimal repro fixture + backlog entry first).
