...
- [x] *(auto-generated 2026-08)* **Bump alloy oracle 2.2.0 -> 2.4.0** in
  ...
  `decoder-crypto-zk/tests/ecdsa_tests.rs:156` (surfaced by clippy 1.96.0,
  unrelated to the bump) that was blocking the workspace clippy gate.
- [ ] *(auto-generated 2026-08)* **Bump solana-transaction-status 4.1.2 ->
  4.2.0** in decoder-solana dev-deps; re-run
  `solana_transaction_status_differential`. Newly surfaced in
  `upstream_outdated`.
