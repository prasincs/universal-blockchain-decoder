...
- [x] *(auto-generated 2026-08)* **Bump alloy oracle 2.2.0 -> 2.3.0** in
  ...
  `cargo update` moved `alloy-consensus`/`alloy-eips` 2.2.0 -> 2.3.0 (plus
  transitive `alloy-serde`/`alloy-tx-macros`) and `alloy-rlp`/`alloy-rlp-derive`
  ...
  No findings. `upstream_outdated` 7 -> 4.)
