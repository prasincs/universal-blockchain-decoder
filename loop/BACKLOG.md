...
- [x] *(auto-generated 2026-08)* **Bump alloy oracle 2.2.0 -> 2.4.1** in
  ...
  (and alloy-serde/alloy-tx-macros in lockstep) in Cargo.lock. alloy-primitives
  stays at 1.x (separately versioned, never in `upstream_outdated`). No API
  migration needed — all 7 `alloy_differential` tests still agree field-for-field
